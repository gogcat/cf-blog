  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col">
          ...
          <Container>
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="flex items-center space-x-6">
                <Link 
                  href="/" 
                  className={`text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 ${pathname === '/' ? 'text-primary-600' : ''}`}
                >
                  首页
                </Link>
                <Link 
                  href="/posts" 
                  className={`text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 ${pathname === '/posts' ? 'text-primary-600' : ''}`}
                >
                  文章
                </Link>
                <Link 
                  href="/friends" 
                  className={`text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 ${pathname === '/friends' ? 'text-primary-600' : ''}`}
                >
                  友链
                </Link>
                <ThemeToggle />
        ...
        <main className="flex-1 bg-gray-50 dark:bg-gray-800 pb-8">{children}</main>
        <footer className="bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
          <Container>
            <div className="py-8 text-center text-gray-600 dark:text-gray-300">
              {settingsLoading ? (
                <div className="animate-pulse h-4 w-48 bg-gray-200 dark:bg-gray-700 rounded mx-auto"></div>
              ) : (
              ...
              <Link href="/sitemap.xml" className="text-sm text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 mt-2 inline-block">
                Sitemap
              </Link>
            </div>
          </Container>
