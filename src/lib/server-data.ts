...
export async function getPostBySlug(slug: string): Promise<Post | null> {
  try {
    ...
    return {
      ...
      moderation_status: (result as { moderation_status: string }).moderation_status || 'approved',
      moderation_note: (result as { moderation_note: string | null }).moderation_note,
      moderated_by: (result as { moderated_by: string | null }).moderated_by,
      moderated_at: (result as { moderated_at: string | null }).moderated_at,
